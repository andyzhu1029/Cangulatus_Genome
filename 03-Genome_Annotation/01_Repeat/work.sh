...
/path/LTR_retriever/bin/ltr_finder -D 20000 -d 1000 -L 3500 -l 100 -p 20 -C -M 0.9 ../../Celastrus_angulatus_B_genome.fasta >CanB.finder.scn 

#LTR_retriever
source /path/conda.sh
conda activate /path/envs/LTR_retriever
conda info --envs
